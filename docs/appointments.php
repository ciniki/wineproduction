...
function ciniki_wineproduction__appointments($ciniki, $tnid, $args) {
    ...
    $strsql = "SELECT ciniki_wineproductions.id AS order_id, "
        ...
        . "JOIN ciniki_wineproduction_products ON (ciniki_wineproductions.product_id = ciniki_wineproduction_products.id "
    ...
    if( isset($args['customer_id']) && $args['customer_id'] != '' ) {
        ...
        return array('stat'=>'fail', 'err'=>array('code'=>'ciniki.wineproduction.3', 'msg'=>'No constraints provided'));
    }
