...
//    this.init = function() {
        ...
        this.main.sections = {
            ...
            'order.flags':{'label':'Order Options', 'type':'gridform', 'rows':12, 'cols':2,
...
//                    {'id':'order.flags.12.fontcolour', 'label':'Font Colour', 'type':'colour'},
            ...
            'bottling.flags':{'label':'Appointment Confirmation', 'type':'gridform', 'rows':9, 'cols':2,
                'header':['Flag Name','Background','Font'],
                'rowhistory':'yes', 'fields':[
...
//                    {'id':'bottling.flags.8.fontcolour', 'label':'Font Colour', 'type':'colour'},
            ...
            'bottling.status':{'label':'Bottling Status Options', 'type':'gridform', 'rows':4, 'cols':2,
