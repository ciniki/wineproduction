...
function ciniki_wineproduction_main() {
    ...
    this.menu.sections = {
        ...
        'started':{'label':'Started', 'type':'simplegrid', 'num_cols':9, 'offset':'yes',
            ...
            'sortable':'yes',
            'headerValues':['Loc', '', 'Inv#', 'Wine', 'Type', 'Started', 'Bottling', 'Racking', ''],
        ...
        'tsgreadings':{'label':'Transfer SG Readings', 'type':'simplegrid', 'num_cols':8, 'offset':'yes',
            ...
            'headerValues':['Loc', '', 'Inv#', 'Wine', 'Type', 'SG', '', ''],
            'sortable':'yes',
        ...
        'transferring':{'label':'Transferring', 'type':'simplegrid', 'num_cols':11, 'offset':'yes',
            ...
            'headerValues':['Loc', '', 'Inv#', 'Wine', 'Type', 'SG', 'Started', 'Bottling', 'Transferring', '', ''],
            'sortable':'yes',
        ...
        'transferred':{'label':'Transferred', 'type':'simplegrid', 'num_cols':10, 'offset':'yes',
            ...
            'headerValues':['Loc', '', 'Inv#', 'Wine', 'Type', 'SG', 'Started', 'Bottling', 'Racking', ''],
            'sortable':'yes',
            'sortTypes':['', '', 'number', 'text', 'text', 'number', 'date', 'date', 'date', ''],
        ...
        'racked':{'label':'Racked', 'type':'simplegrid', 'num_cols':10, 'offset':'yes',
            ...
            'headerValues':['Loc', '', 'Inv#', 'Wine', 'Type', 'SG', 'Racked', 'Bottling', 'Filtering',''],
            'sortable':'yes',
            'sortTypes':['', '', 'number', 'text', 'text', 'number', 'date', 'date', 'date', ''],
        ...
        'filtering':{'label':'Filtering', 'type':'simplegrid', 'num_cols':10, 'offset':'yes',
            ...
            'headerValues':['Loc', '', 'Inv#', 'Wine', 'Type', 'Racked', 'Bottling', 'Filtering', '', ''],
            'sortable':'yes',
            'sortTypes':['', '', 'number', 'text', 'text', 'date', 'date', 'date', '', ''],
...
//            }
    ...
    this.order.sections = {
        ...
        'details':{'label':'Details', 'fields':{
            ...
            'start_date':{'label':'Started', 'type':'date', 'caloffset':0, 'months':3},
            }},
        'details2':{'label':'', 'fields':{
            ...
            'transferring_date':{'label':'Transferring', 'type':'date', 'caloffset':0, 'colourize':'bg', 'months':3,
                'visible':function() { return (M.modFlagOn('ciniki.wineproduction', 0x0800) && M.ciniki_wineproduction_main.order.data.transfer == 'yes' ? 'yes' : 'no'); },
                },
            'transfer_date':{'label':'Transferred On', 'type':'date', 'caloffset':0, 'months':3,
                'visible':function() { return (M.modFlagOn('ciniki.wineproduction', 0x0800) && M.ciniki_wineproduction_main.order.data.transfer == 'yes' ? 'yes' : 'no'); },
                },
            'sg_reading':{'label':'Racking SG', 'type':'text', 'size':'small', 'separator':'no'},
            'racking_date':{'label':'Racking', 'type':'date', 'caloffset':0, 'colourize':'bg', 'months':3},
            'rack_date':{'label':'Racked On', 'type':'date', 'caloffset':0, 'months':3},
            'filtering_date':{'label':'Filtering', 'type':'date', 'caloffset':0, 'colourize':'bg', 'separator':'yes', 'months':3},
            'filter_date':{'label':'Filtered On', 'type':'date', 'caloffset':0, 'months':3},
            'bottle_date':{'label':'Bottled', 'type':'date', 'caloffset':0, 'months':3},
        ...
        M.api.getJSONCb('ciniki.wineproduction.getOrder', 
            {'tnid':M.curTenantID, 'wineproduction_id':this.order_id}, function(rsp) {
                ...
                if( rsp.order.customer_id > 0 ) {
                    ...
                    p.sections.customer.addFn = 'M.startApp(\'ciniki.customers.main\',null,\'M.ciniki_wineproduction_main.order.open();\',\'mc\',{\'next\':\'M.ciniki_wineproduction_main.order.updateCustomer\',\'customer_id\':M.ciniki_wineproduction_main.order.customer_id});';
                    p.sections.customer.changeTxt = 'Change Customer';
                    p.data.customer = rsp.order.customer;
                } else {
                    p.sections.customer.addTxt = 'Add Customer';
                    p.sections.customer.addFn = 'M.startApp(\'ciniki.customers.edit\',null,\'M.ciniki_wineproduction_main.order.open();\',\'mc\',{\'next\':\'M.ciniki_wineproduction_main.order.updateCustomer\',\'action\':\'change\',\'current_id\':M.ciniki_wineproduction_main.order.customer_id});';
