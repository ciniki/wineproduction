...
// -------
//
function ciniki_wineproduction_orderUpdate(&$ciniki) {
    //
    ...
    $rc = ciniki_wineproduction_checkAccess($ciniki, $args['tnid'], 'ciniki.wineproduction.orderUpdate');
    if( $rc['stat'] != 'ok' ) {
        return $rc;
    }
    ...
    //
    // Update the Wine Production Order in the database
    //
    ciniki_core_loadMethod($ciniki, 'ciniki', 'core', 'private', 'objectUpdate');
    $rc = ciniki_core_objectUpdate($ciniki, $args['tnid'], 'ciniki.wineproduction.order', $args['order_id'], $args, 0x04);
    if( $rc['stat'] != 'ok' ) {
    ...
    ciniki_core_hookExec($ciniki, $args['tnid'], 'ciniki', 'web', 'indexObject', array('object'=>'ciniki.wineproduction.order', 'object_id'=>$args['order_id']));
