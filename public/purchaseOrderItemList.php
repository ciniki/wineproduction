...
// Description
// -----------
// This method will return the list of Purchase Order Items for a tenant.
//
// Arguments
// ---------
// api_key:
...
// -------
//
function ciniki_wineproduction_purchaseOrderItemList($ciniki) {
    //
    ...
    $rc = ciniki_wineproduction_checkAccess($ciniki, $args['tnid'], 'ciniki.wineproduction.purchaseOrderItemList');
    if( $rc['stat'] != 'ok' ) {
        return $rc;
    }
    ...
    $rc = ciniki_core_dbHashQueryArrayTree($ciniki, $strsql, 'ciniki.wineproduction', array(
        array('container'=>'items', 'fname'=>'id', 
            'fields'=>array('id', 'order_id', 'product_id', 'description', 'quantity_ordered', 'quantity_received', 'unit_amount', 'taxtype_id')),
        ));
    if( $rc['stat'] != 'ok' ) {
        return $rc;
    }
